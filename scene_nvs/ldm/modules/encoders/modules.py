...
# TODO: can we directly rely on lucidrains code and simply add this as a reuirement?
from ldm.modules.x_transformer import Encoder, TransformerWrapper
from ldm.thirdp.psp.id_loss import IDFeatures
from ldm.util import count_params, default, instantiate_from_config
...
class SpatialRescaler(nn.Module):
    def __init__(
        ...
        if self.remap_output:
            print(
                f"Spatial Rescaler mapping from {in_channels} to \
                    {out_channels} channels after resizing."
            )
