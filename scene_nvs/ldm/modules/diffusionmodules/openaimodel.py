...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        # custom support for prediction of discrete ids into codebook
        # of first stage vq model
        n_embed=None,
        legacy=True,
        ...
        if disable_self_attentions is not None:
            ...
            # indicating whether to disable self-attention in TransformerBlocks or not
        ...
        if num_attention_blocks is not None:
            ...
            print(
                f"Constructor of UNetModel received \
                    num_attention_blocks={num_attention_blocks}. "
                f"This option has LESS priority than \
                    attention_resolutions {attention_resolutions}, "
                f"i.e., in cases where num_attention_blocks[i] > 0 \
                    but 2**i not in attention_resolutions, "
