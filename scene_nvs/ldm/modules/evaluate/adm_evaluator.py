...
INCEPTION_V3_URL = "https://openaipublic.blob.core.windows.net/diffusion/jul-2021/ref_batches/classify_image_graph_def.pb"  # noqa
...
class FIDStatistics:
    ...
    def frechet_distance(self, other, eps=1e-6):
        ...
        """
        # https://github.com/bioinf-jku/TTUR/blob/73ab375cdf952a12686d9aa7978567771084da42/fid.py#L132 # noqa
        ...
        assert (
            mu1.shape == mu2.shape
        ), f"Training and test mean vectors have different lengths: \
            {mu1.shape}, {mu2.shape}"
        assert (
...
class Evaluator:
    ...
    def compute_inception_score(
        ...
        # https://github.com/openai/improved-gan/blob/4f5d1ec5c16a7eceb206f42bfc652693601e1d5c/inception_score/model.py#L46 # noqa
        scores = []
...
class ManifoldEstimator:
    ...
    Adapted from https://github.com/kynkaat/improved-precision-and-recall-metric/blob/f60f25e5ad933a79135c783fcda53de30f42c9b9/precision_recall.py#L57 # noqa
    """
    ...
    def evaluate(
        ...
        for begin1 in range(0, num_eval_images, self.row_batch_size):
            ...
            # From the minibatch of new feature vectors,
            # determine if they are in the estimated manifold.
            # If a feature vector is inside a hypersphere of some reference sample,
            # then the new sample lies at the estimated manifold.
            # The radii of the hyperspheres are determined
            # from distances of neighborhood size k.
...
class DistanceBlock:
    ...
    Adapted from https://github.com/kynkaat/improved-precision-and-recall-metric/blob/f60f25e5ad933a79135c783fcda53de30f42c9b9/precision_recall.py#L34 # noqa
    """
...
def _read_bytes(fp, size, error_template="ran out of data"):
    """
    Copied from: https://github.com/numpy/numpy/blob/fb215c76967739268de71aa4bda55dd1b062bc2e/numpy/lib/format.py#L788-L886 # noqa
